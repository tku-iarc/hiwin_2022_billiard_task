...
###
start_point = [-368.000, -0.042 ,293.500, 180.000, 0.000, 90]
pic_Point = [-1.034, 408.671, 359.568, 180.000, 0, 90]
...
def find_cueball(data):
 ...
 #=====================================================================
    ...
    all_ball = [[-999 for i in range(6)] for j in range(16)]
    ...
    for item in data:
        ...
        all_ball[i] = [BASE_X , BASE_Y , -63 , 180 , 0 , -179.929]
        i+=1
...
if __name__ == "__main__":
    ...
    while 1:
        ...
        ball_information = Houghcircles.HoughCircles(img)
        ...
        all_ball = find_cueball(ball_information)
        print(all_ball)
        cueball_point = all_ball[1]
        print(cueball_point)
